...
int main( int argc, char **argv){
 ...
 for ( i = 0; i < nchan; i++) datasum[i] = data1[i]+data2[i];
 
 fwrite (datasum, nchan, NCHAN*sizeof(DATATYPE), fileptr);
